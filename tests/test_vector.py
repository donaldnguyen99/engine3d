...
class TestVector2D:
    ...
    def test_vector2d_dot(self):
        ...
        assert v2.dot(v2) == 61
        v3 = Vector2D(0, 0.1)
        assert np.isclose(v3.dot(v3), 0.01,
                          rtol=Vector2D.EPSILON, atol=Vector2D.EPSILON)
    ...
    def test_vector2d_to_bytes(self):
        v = Vector2D(3, 4)
        assert v.to_bytes() == b"\x00\x00\x00\x00\x00\x00\x08@\x00\x00\x00\x00\x00\x00\x10@"
    ...
    def test_vector2d__zero(self):
        v = Vector2D(3, 4)
        assert v != Vector2D._zero(2)
        v1 = Vector2D(0, 0)
        assert v1 == Vector2D._zero(2)
    ...
    def test_vector2d__one(self):
        v = Vector2D(3, 4)
        assert v != Vector2D._one(2)
        v1 = Vector2D(1, 1)
        assert v1 == Vector2D._one(2)
